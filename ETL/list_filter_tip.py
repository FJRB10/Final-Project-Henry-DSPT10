...
def upload_data():
    ...
    gcs_hook.upload(bucket_name=BUCKET, object_name='data/data_city_filter/tip_filtered.csv', filename=transformed_path) 
...
with DAG(
    ...
    download_task = PythonOperator(
        task_id=f'download',
        python_callable=download_file_tip
    )
